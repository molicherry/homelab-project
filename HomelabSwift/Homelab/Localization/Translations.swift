    ...
    static func forLanguage(_ language: Language) -> ArrStrings {
        ...
        case .zh:
            return ArrStrings(
                ...
                tutorialTitle: "几分钟内完成媒体 ARR 配置",
                tutorialBody: "仅配置你实际使用的服务。",
                tutorialStepConnect: "为每个服务添加 URL 和凭据/API 密钥。",
                tutorialStepOpen: "打开每张卡片进行快速操作和状态查看。",
                tutorialStepAutomations: "备份和设置保持同步。",
                tutorialActionConfigure: "配置服务",
                tutorialActionDismiss: "隐藏指南",
                quickSetupTitle: "未配置的服务",
                quickSetupSubtitle: "只添加你真正需要的。",
                addService: { "添加 \($0)" },
                connection: "连接",
                download: "下载",
                upload: "上传",
                ...
                recheckStarted: "重新检查已开始",
                reannounceQueued: "重新通告已排队",
                ...
                requestConfigurationMessage: "选择用于此请求的配置文件与文件夹。",
                ...
                downloadedScanQueued: "下载扫描已排队",
                healthCheckQueued: "健康检查已排队",
                requests: "请求",
                approveOldestPending: "批准最早的待处理",
                declineOldestPending: "拒绝最早的待处理",
                ...
                testIndexers: "测试索引器",
                syncApps: "同步应用",
                indexerTestStarted: "索引器测试已开始",
                applicationSyncStarted: "应用同步已开始",
                subtitles: "字幕",
                vpn: "VPN",
                ...
                oldestPendingApproved: "最早的待处理请求已批准",
                oldestPendingDeclined: "最早的待处理请求已拒绝",
                recentScanStarted: "最近扫描已开始",
                fullScanStarted: "完整扫描已开始",
                vpnRestartQueued: "VPN 隧道重启已开始",
